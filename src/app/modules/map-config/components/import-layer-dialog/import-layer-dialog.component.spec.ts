...
import { ArlasCollaborativesearchService, ArlasConfigService, ArlasConfigurationDescriptor, ArlasStartupService, AuthentificationService, getOptionsFactory, GET_OPTIONS, PersistenceService } from 'arlas-wui-toolkit';
